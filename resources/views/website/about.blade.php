...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="crumina-module crumina-module-slider bg-blue-lighteen medium-padding100" style="background: linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)),url({{asset('website/img/purple_bg.jpg')}}); background-size: cover; border-top: 5px solid red; border-bottom: 5px solid red;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="teammembers-wrap" style="margin-top: 15%;">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/kareem2.png')}}" alt="kareem tarek team member" width="200" style="border-radius: 50px; height: 100%;">
                                </div>
                                ...
                                <div class="teammember-content">
                                    ...
                                    <a href="javascript:void(0);" style="cursor: context-menu;" class="h5 teammembers-item-name">{{__('admin/home.kareem_tarek')}}</a>

                                    <div class="teammembers-item-prof">01010110457</div>

                                    <div class=""><a href="https://www.linkedin.com/in/kareem-tarek-1899a71a0/" style="color: #0083FF;" onMouseOver="this.style.color='#151414'" onMouseOut="this.style.color='#0083FF'">{{__('admin/home.kareem_linkedin_url')}}</a></div>
                            ...
                            <div class="crumina-module crumina-teammembers-item" style="margin-top: 25%;">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/BaraaDev.jpg')}}" alt="baraa team member" width="200" style="border-radius: 50px; height: 100%;">
                                </div>
                                ...
                                <div class="teammember-content">
                                    ...
                                    <a href="javascript:void(0);" style="cursor: context-menu;" class="h5 teammembers-item-name">{{__('admin/home.baraa_samy')}}</a>

                                    <div class="teammembers-item-prof">01065858355</div>

                                    <div class=""><a href="https://www.linkedin.com/in/baraadev/" style="color: #0083FF;" onMouseOver="this.style.color='#151414'" onMouseOut="this.style.color='#0083FF'">{{__('admin/home.baraa_linkedin_url')}}</a></div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/Khalifa.jpeg')}}" alt="Ahmed Khalifa team member" width="200" style="border-radius: 50px; height: 100%;">
                                </div>
                                ...
                                <div class="teammember-content">
                                    ...
                                    <a href="javascript:void(0);" style="cursor: context-menu;" class="h5 teammembers-item-name">{{__('admin/home.ahmed_khalifa')}}</a>

                                    <div class="teammembers-item-prof">01112554996</div>

                                    <div class=""><a href="https://www.linkedin.com/in/ahmed-saeed-khalifa-98871123b/" style="color: #0083FF;" onMouseOver="this.style.color='#151414'" onMouseOut="this.style.color='#0083FF'">{{__('admin/home.khalifa_linkedin_url')}}</a></div>
