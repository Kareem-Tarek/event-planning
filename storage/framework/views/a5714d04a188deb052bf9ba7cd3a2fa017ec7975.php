...
<script src="<?php echo e(asset('website/js/jquery-3.3.1.js')); ?>"></script>

<!-- jQuery-scripts for Template -->

<script src="<?php echo e(asset('website/js/js-plugins/jquery.countdown.min.js')); ?>"></script>

<script src="<?php echo e(asset('website/js/js-plugins/crum-mega-menu.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/swiper.jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/jquery.typeahead.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/velocity.min.js')); ?>"></script>

<script src="<?php echo e(asset('website/js/js-plugins/waypoints.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/jquery-countTo.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/jquery.nice-select.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/imagesLoaded.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/jquery.magnific-popup.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/jquery.matchHeight.js')); ?>"></script>
<script src="<?php echo e(asset('website/js/js-plugins/Headroom.js')); ?>"></script>
