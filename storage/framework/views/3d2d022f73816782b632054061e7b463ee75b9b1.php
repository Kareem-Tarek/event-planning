...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - <?php echo e(__('admin/home.home')); ?></title>
    <!-- Google font-->
...
<body class="<?php if(LaravelLocalization::getCurrentLocale() == 'ar'): ?> rtl <?php else: ?> ltr <?php endif; ?> <?php echo e($theme); ?>">
