                    ...
                    <div class="teammembers-wrap" style="margin-top: 15%;">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="<?php echo e(asset('website/img/kareem2.png')); ?>" alt="kareem tarek team member" width="200" style="border-radius: 50px; height: 100%;">
                                </div>
                                ...
                                <div class="teammember-content">
                                    ...
                                    <a href="javascript:void(0);" style="cursor: context-menu;" class="h5 teammembers-item-name"><?php echo e(__('admin/home.kareem_tarek')); ?></a>

                                    <div class="teammembers-item-prof">01010110457</div>

                                    <div class=""><a href="https://www.linkedin.com/in/kareem-tarek-1899a71a0/" style="color: #0083FF;" onMouseOver="this.style.color='#151414'" onMouseOut="this.style.color='#0083FF'"><?php echo e(__('admin/home.kareem_linkedin_url')); ?></a></div>
                            ...
                            <div class="crumina-module crumina-teammembers-item" style="margin-top: 25%;">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="<?php echo e(asset('website/img/BaraaDev.jpg')); ?>" alt="baraa team member" width="200" style="border-radius: 50px; height: 100%;">
                                </div>
                                ...
                                <div class="teammember-content">
                                    ...
                                    <a href="javascript:void(0);" style="cursor: context-menu;" class="h5 teammembers-item-name"><?php echo e(__('admin/home.baraa_samy')); ?></a>

                                    <div class="teammembers-item-prof">01065858355</div>

                                    <div class=""><a href="https://www.linkedin.com/in/baraadev/" style="color: #0083FF;" onMouseOver="this.style.color='#151414'" onMouseOut="this.style.color='#0083FF'"><?php echo e(__('admin/home.baraa_linkedin_url')); ?></a></div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="<?php echo e(asset('website/img/Khalifa.jpeg')); ?>" alt="Ahmed Khalifa team member" width="200" style="border-radius: 50px; height: 100%;">
                                </div>
                                ...
                                <div class="teammember-content">
                                    ...
                                    <a href="javascript:void(0);" style="cursor: context-menu;" class="h5 teammembers-item-name"><?php echo e(__('admin/home.ahmed_khalifa')); ?></a>

                                    <div class="teammembers-item-prof">01112554996</div>

                                    <div class=""><a href="https://www.linkedin.com/in/ahmed-saeed-khalifa-98871123b/" style="color: #0083FF;" onMouseOver="this.style.color='#151414'" onMouseOut="this.style.color='#0083FF'"><?php echo e(__('admin/home.khalifa_linkedin_url')); ?></a></div>
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\event-planning\resources\views/website/about.blade.php ENDPATH**/ ?>